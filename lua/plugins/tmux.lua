return {
  ...
  keys = {
    ...
    -- resize
    { "<M-e>", "<cmd>lua require('tmux').resize_top()<cr>", desc = "resize pane top" },
    { "<M-f>", "<cmd>lua require('tmux').resize_right()<cr>", desc = "resize pane right" },
    { "<M-c>", "<cmd>lua require('tmux').resize_bottom()<cr>", desc = "resize pane bottom" },
    { "<M-s>", "<cmd>lua require('tmux').resize_left()<cr>", desc = "resize pane left" },
  }
}
